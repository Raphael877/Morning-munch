            ...
            <Categories>
              <div className='categories_wrapper'>
                ...
                <ul>
                  ...
                  <li onClick={() => navigate("breakfast")}><p>Breakfast combos</p><hr style={{display: "none"}}></hr></li>
                  <li onClick={() => navigate("pastries")}><p>Pastries</p><hr style={{display: "none"}}></hr></li>
                  <li onClick={() => navigate("nuli_drinks")}><p>Drinks</p><hr style={{display: "none"}}></hr></li>
                </ul>
              </div>
              </div>
              <Nuli_All />
...
const Nuli_content = styled.div`
    width: 100%;
    height: auto;
`

const Nuli_wrapper = styled.div`
  width: 100%;
  height: 100%;
  display: flex;
