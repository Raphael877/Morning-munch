...
import Akarapage from '../assets/Akarapage.jpg'
            ...
            <Categories>
              <div className='categories_wrapper'>
                ...
                <ul>
                  ...
                  <li onClick={() => navigate("/about")}><p>Classic combos</p><hr style={{display: "none"}}></hr></li>
                  <li onClick={() => navigate("/others")}><p>Others</p><hr style={{display: "none"}}></hr></li>
                  <li onClick={() => navigate("/akara_drinks")}><p>Drinks</p><hr style={{display: "none"}}></hr></li>
                </ul>
              </div>
              </div>
            </Categories>
...
const Akara_content = styled.div`
    width: 100%;
    height: auto;
`

const Akara_wrapper = styled.div`
  width: 100%;
  height: 100%;
  display: flex;
...
const Image_background = styled.div`
  width: 100%;
  height: 40vh;
  background: linear-gradient(to top, rgba(41, 40, 40, 0.531),rgba(53, 53, 53, 0.531) , rgba(24, 23, 23, 0.531)), url(${Akarapage});
  margin-top: 20vh;
...
const Info = styled.div`
  ...
  .top{
    ...
    .restaurant_logo{
      ...
      height: 3.5rem;
      border-radius: 50%;
      background-image: url(${Akarapage});
      background-position: center;
      background-repeat: no-repeat;
      background-size: cover;
    }
