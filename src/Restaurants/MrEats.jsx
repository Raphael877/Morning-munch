            ...
            <Categories>
              <div className='categories_wrapper'>
                ...
                <ul>
                  ...
                  <li onClick={() => navigate("m_breakfast")}><p>Breakfast combos</p><hr style={{display: "none"}}></hr></li>
                  <li onClick={() => navigate("m_extra")}><p>Extras</p><hr style={{display: "none"}}></hr></li>
                  <li onClick={() => navigate("m_drinks")}><p>Drinks</p><hr style={{display: "none"}}></hr></li>
                </ul>
              </div>
              </div>
              <MrEats_All />
...
export default MrEats

const MrEats_content = styled.div`
    width: 100%;
    height: auto;
`

const MrEats_wrapper = styled.div`
  width: 100%;
  height: 100%;
  display: flex;
